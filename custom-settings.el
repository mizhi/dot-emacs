...
3e32" default)))
 '(package-selected-packages
   (quote
    (exec-path-from-shell enh-ruby-mode rspec-mode danneskjold-theme projectile-rails web-mode smartparens rubocop diff-hl magit-gh-pulls cherry-blossom-theme origami docker-compose-mode flycheck-elixir crontab-mode robe dockerfile-mode erlang csv-mode company-ghci eruby-mode haml-mode yard-mode chruby ruby-refactor floobits w3 ag alchemist anaconda-mode android-mode ant auto-complete col-highlight column-marker company company-anaconda company-c-headers company-ghc company-go company-inf-ruby company-irony concurrent crosshairs ctable darcula-theme deferred dirtree elixir-mix elixir-mode ensime epc fill-column-indicator flycheck-irony flycheck-pos-tip flymake flymake-elixir flymake-go flymake-haml flymake-json flymake-python-pyflakes flymake-ruby go-eldoc go-mode go-projectile groovy-mode hc-zenburn-theme helm-R helm-ag-r helm-aws helm-bibtex helm-c-moccur helm-company helm-flycheck helm-ghc helm-git helm-go-package helm-google helm-package helm-projectile helm-pydoc helm-rails helm-rb hl-line+ inf-ruby javadoc-lookup jedi json-mode magit nasm-mode popup projectile python-environment redis rich-minority ruby-block ruby-electric ruby-hash-syntax ruby-tools scala-mode2 scala-outline-popup snippet vline yaml-mode))))
(custom-set-faces
